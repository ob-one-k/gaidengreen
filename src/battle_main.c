...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA"), 10, BALL_NET },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 8, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 12, BALL_QUICK },
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 15, BALL_NET },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_TIMER },
    ...
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 , BALL_HEAL },
    ...
    [TRAINER_CLASS_NINJA_ADEPT] = { _("NINJA ADEPT"), 5, BALL_DUSK },
    [TRAINER_CLASS_SENSEI] = { _("SENSEI"), 15, BALL_DUSK },
};
