...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_LITTEN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_TORRACAT}), //! -1
    },
    ...
    [SPECIES_TORRACAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_INFILTRATOR, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_SKILL_LINK },
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_NONE, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_BLACK,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_NONE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MELMETAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
