...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_NONE, ABILITY_MAGICIAN },
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_DOUBLADE}),
    },
    ...
    [SPECIES_DOUBLADE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_AEGISLASH_SHIELD}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_DRAGALGE}), //! -6
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_HYDRATION, ABILITY_MAGIC_GUARD, ABILITY_GOOEY },
