...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_PATRAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GUTS, ABILITY_KEEN_EYE, ABILITY_ANALYTIC },
    ...
    [SPECIES_ARCHEN] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DUCKLETT] =
    {
        ...
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_BIG_PECKS, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SOLID_ROCK, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEFIANT, ABILITY_GLUTTONY, ABILITY_WHITE_SMOKE },
        .bodyColor = BODY_COLOR_RED,
