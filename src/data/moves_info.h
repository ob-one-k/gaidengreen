...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .effect = EFFECT_MULTI_HIT,
        .power = 20, //* +5
        .type = TYPE_FIGHTING, //* changed from normal
        .accuracy = 95, //* +10
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .power = 80,
        .type = TYPE_FLYING, //* changed from normal
        .accuracy = 100,
        .criticalHitStage = 1,
        .pp = 10,
    ...
    [MOVE_DOUBLE_EDGE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = { .recoilPercentage = 25 }, //! -8
        .makesContact = TRUE,
        .contestEffect = CONTEST_EFFECT_USER_MORE_EASILY_STARTLED,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
    ...
    [MOVE_SWAGGER] =
    {
        ...
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 ? 95 : 95,//*
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_KNOCK_OFF] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 45 : 45,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_DIVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "turn and strikes next turn."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 80 : 80,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_GUNK_SHOT] =
    {
        ...
        .power = 120,
        .type = TYPE_POISON,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 90,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        #endif
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 60 : 60, //!
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_8 ? 20 : 20, //*
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
