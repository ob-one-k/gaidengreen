...
#define SHOULD_SWITCH_ALL_MOVES_BAD_PERCENTAGE                  0 //! -50
...
#define STAY_IN_ABSORBING_PERCENTAGE                                100  //! -16 //Chance to stay in if outgoing mon has super effective move against player, will prevent switching out for an absorber with this likelihood
#define SHOULD_SWITCH_HASBADODDS_PERCENTAGE                         0 //! -33
#define SHOULD_SWITCH_ENCORE_STATUS_PERCENTAGE                      0 //! -100
#define SHOULD_SWITCH_ENCORE_DAMAGE_PERCENTAGE                      0 //! -50
#define SHOULD_SWITCH_CHOICE_LOCKED_PERCENTAGE                      0 //! Only if locked into status move
#define SHOULD_SWITCH_ATTACKING_STAT_MINUS_TWO_PERCENTAGE           0 //! -33
#define SHOULD_SWITCH_ATTACKING_STAT_MINUS_THREE_PLUS_PERCENTAGE    0 //! -100
#define SHOULD_SWITCH_ALL_SCORES_BAD_PERCENTAGE                     0 //! -100

// AI smart switching chances for bad statuses
#define SHOULD_SWITCH_PERISH_SONG_PERCENTAGE                    0
#define SHOULD_SWITCH_YAWN_PERCENTAGE                           0 //! -100
#define SHOULD_SWITCH_BADLY_POISONED_PERCENTAGE                 0 //! -50
#define SHOULD_SWITCH_BADLY_POISONED_STATS_RAISED_PERCENTAGE    0 //! -20
#define SHOULD_SWITCH_CURSED_PERCENTAGE                         0
#define SHOULD_SWITCH_CURSED_STATS_RAISED_PERCENTAGE            0 //! -20
#define SHOULD_SWITCH_NIGHTMARE_PERCENTAGE                      0
#define SHOULD_SWITCH_NIGHTMARE_STATS_RAISED_PERCENTAGE         0 //! -33
#define SHOULD_SWITCH_SEEDED_PERCENTAGE                         0 //! -50
#define SHOULD_SWITCH_SEEDED_STATS_RAISED_PERCENTAGE            0 //! -10
#define SHOULD_SWITCH_INFATUATION_PERCENTAGE                    0 //! -50

// AI smart switching chances for beneficial abilities
#define SHOULD_SWITCH_NATURAL_CURE_STRONG_PERCENTAGE                50 //! -16
#define SHOULD_SWITCH_NATURAL_CURE_STRONG_STATS_RAISED_PERCENTAGE   0 //! -25
#define SHOULD_SWITCH_NATURAL_CURE_WEAK_PERCENTAGE                  25 //* +25
#define SHOULD_SWITCH_NATURAL_CURE_WEAK_STATS_RAISED_PERCENTAGE     0 //! -10
#define SHOULD_SWITCH_REGENERATOR_PERCENTAGE                        33
#define SHOULD_SWITCH_REGENERATOR_STATS_RAISED_PERCENTAGE           0 //! -20
...
#define PREDICT_SWITCH_CHANCE                                   0 //! -50
