...
//#define AI_FLAG_SMART_TRAINER_TEST      (AI_FLAG_SMART_TRAINER)
//#define AI_FLAG_SMART_TRAINER_ACE       (AI_FLAG_SMART_TRAINER | AI_FLAG_ACE_POKEMON)
//#define AI_FLAG_SMART_TRAINER_DUB_ACE   (AI_FLAG_SMART_TRAINER | AI_FLAG_DOUBLE_ACE_POKEMON)
//#define AI_FLAG_SMART_TRAINER_RISKY     (AI_FLAG_SMART_TRAINER | AI_FLAG_RISKY | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)
